...
import demo.models.user.ERole;
import demo.models.user.Role;
import demo.models.user.User;
import demo.payload.request.LoginRequest;
import demo.payload.request.SignupRequest;
import demo.payload.response.JwtResponse;
import demo.payload.response.MessageResponse;
import demo.repositories.user.RoleRepository;
import demo.repositories.user.UserRepository;
import demo.security.jwt.JwtUtils;
import demo.services.impl.user.UserDetailsImpl;
